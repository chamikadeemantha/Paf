    ...
    return (
        <div>
            <div className="Auth_container" role="main">
                <div className="Auth_singleContainer">
                    <div className="Auth_header">
                        <h1 className="Auth_heading" id="registration-title">Create your account</h1>
                        <p className="Auth_subheading">Complete the form below - Step {formStep} of 3</p>
                    </div>
                    
                    <form onSubmit={handleSubmit} className="Auth_form" aria-labelledby="registration-title">
                        {formStep === 1 && (
                            <fieldset className="form-step">
                                ...
                                <div className="Auth_formGroup">
                                    ...
                                    <input
                                        id="fullname"
                                        className={`Auth_input ${errors.fullname ? 'input-error' : ''}`}
                                        type="text"
                                        name="fullname"
                                        aria-required="true"
                                ...
                                <div className="Auth_formGroup">
                                    ...
                                    <input
                                        id="email"
                                        className={`Auth_input ${errors.email ? 'input-error' : ''}`}
                                        type="email"
                                        name="email"
                                        aria-required="true"
                                ...
                                <div className="Auth_formGroup">
                                    ...
                                    <input
                                        id="password"
                                        className={`Auth_input ${errors.password ? 'input-error' : ''}`}
                                        type="password"
                                        name="password"
                                        aria-required="true"
                        ...
                        {formStep === 2 && (
                            <fieldset className="form-step">
                                ...
                                <div className="Auth_formGroup profile-upload-section">
                                    ...
                                    <div 
                                        className={`profile-upload-container ${profilePicture.error ? 'error-border' : ''}`} 
                                ...
                                <div className="Auth_formGroup">
                                    ...
                                    <input
                                        id="phone"
                                        className={`Auth_input ${errors.phone ? 'input-error' : ''}`}
                                        type="text"
                                        name="phone"
                                        aria-required="true"
            ...
            {isVerificationModalOpen && (
                <div className="verification-modal" role="dialog" aria-labelledby="verification-title">
                    <div className="modal-content">
                        ...
                        <h2 id="verification-title" className='veryname'>Verify Your Email</h2>
